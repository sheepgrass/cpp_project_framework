...
macro(cpf_add_doxygen_target)
    ...
    if(DOXYGEN_PROGRAM STREQUAL "DOXYGEN_PROGRAM-NOTFOUND")
        ...
        set(SET_DOXYFILE_VALUES_SNIPPET "${SET_DOXYFILE_VALUES_SNIPPET} kvs['OUTPUT_DIRECTORY'] = 'docs';")
        ...
        if(WIN32)
            ...
            add_custom_command(TARGET doxygen_create_config COMMAND bash -c "${VENV_ACTIVATE_CMD} && ${UPDATE_DOXYFILE_CMD}" WORKING_DIRECTORY ${CMAKE_SOURCE_DIR})
            add_custom_command(TARGET doxygen COMMAND bash -c "${VENV_ACTIVATE_CMD} && ${PRINT_DOXYGEN_HTML_PATH_CMD}" WORKING_DIRECTORY ${CMAKE_SOURCE_DIR})
        endif()
    endif()
endmacro()
