...
macro(cpf_add_doxygen_target)
    ...
    if(DOXYGEN_PROGRAM STREQUAL "DOXYGEN_PROGRAM-NOTFOUND")
        ...
        file(TO_NATIVE_PATH "${CMAKE_SOURCE_DIR}/docs/html/index.html" DOXYGEN_HTML_PATH)
        ...
        add_custom_command(TARGET doxygen COMMAND ECHO HTML Source Code Documentation: ${DOXYGEN_HTML_PATH} WORKING_DIRECTORY ${CMAKE_SOURCE_DIR})
    endif()
endmacro()
